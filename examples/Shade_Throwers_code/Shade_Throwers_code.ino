...
BH1750_Init(BH1750address); //Initializes the I2C connection at this address
  ...
  // I do not understand the numbers in this code
    float Nval = ((((buff[0]<<8)|buff[1])/1.2) - 5)*160/1000; //?
    int mid = (int) Nval;
    float fin;
    //The  next part of the code limits fin to between o and 189 degrees.
    ...
    Serial.print("     ");
    Serial.print((((buff[0]<<8)|buff[1])/1.2)); // Why? what is this?
    Serial.print("     ");
    Serial.println(q); // what the heck is q
